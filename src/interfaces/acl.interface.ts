...
export type Permission = 'addVideo' | 'removeVideo' | 'forceNext' | 'forcePlay' | 'skipVideo' | 'editBox' |
'setModerator' | 'unsetModerator' | 'setVIP' | 'unsetVIP' | 'bypassVideoDurationLimit' | 'inviteUser' | 'bypassBerries'
